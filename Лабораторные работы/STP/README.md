...
В нашем примере стоимости портов равны, BID равны, значит для определения корневого порта используются приоритеты портов. Наиболее низкие значения в приоритете. 
