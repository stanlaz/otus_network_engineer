...
Как видно из текущей конфигурации порт e0/3 на коммутаторе S3 заблокирован STP по наибольшему значению BID, при том том, что стоимость портов корневого моста на коммутаторах S2 и S3 одинакова.  
Теперь уменьшим стоимость порта корневого моста на коммутаторе S3:
